...
<div class="container main" >
    <h3> แก้ไขรายการซื้อเลขที่ {{Request::segment(2)}} </h3>
    <hr />
    <div class="row">
    ...
    <div class="row form-group">
        ...
        <div class="col-md-4">
            <div class="input-group date">
                <input class="datepicker form-control" data-date-format="dd/mm/yyyy" id="purchase_date" />
    ...
    <div class="row card m-t-30">
        ...
        <div class="col-md-12 float-right text-right">
            <h5><strong>มูลค่ารวม : <span class="PURCHASE_TOTAL"> 0.00 </span></strong></h5>
        </div>
    </div>
